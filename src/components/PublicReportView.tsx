...
// Reutiliza el lenguaje visual .bal-* del Panel de Estadísticas: hero, tarjetas
// con acento a color, donut de género, barra de edad, matriz responsive y
// ranking de parroquias. Recibe estadísticas AGREGADAS por props.
...
export default function PublicReportView({ stats, refugioLabel, sharedBy, ubicacion }: PublicReportProps) {
  ...
  const cards: { label: string; value: number; suffix?: string; sub?: string | null; accent: string; icon: ReactNode }[] = [
    ...
    { label: "Retirados", value: S.totalRetirados || 0, accent: "#64748b", icon: IC.userx },
  ];
