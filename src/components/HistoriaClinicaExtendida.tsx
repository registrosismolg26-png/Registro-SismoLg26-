...
export function HistoriaClinicaExtendida({ formData, onChange, readOnly = false }: Props) {
  // Helpers para manejar los inputs pill
  ...
  return (
    <div className="pill-form">
      ...
      <SectionTitle>Impresión Diagnóstica y Plan</SectionTitle>
      <div className="detail-grid">
