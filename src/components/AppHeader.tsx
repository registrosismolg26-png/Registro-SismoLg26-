    ...
    <>
      ...
      <div className="app-nav">
        <div className="nav-desktop-menu" ref={navDesktopRef}>
          ...
          {(isMaster(currentUser.role) || currentUser.role === "ADMIN") && (
            <button
              type="button"
              data-tab="nuevos-afectados"
              className={`nav-btn ${activeTab === "nuevos-afectados" ? "active" : ""}`}
              onClick={() => setActiveTab("nuevos-afectados")}
            >
        ...
        <div className="nav-mobile-menu">
          <div className="nav-mobile-primary">
            <span className="nav-mobile-active-tab">
              ...
              {activeTab === "nuevos-afectados" && <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg> Nuevos afectados</>}
          ...
          {menuOpen && (
            <div className="nav-mobile-dropdown">
              ...
              {(isMaster(currentUser.role) || currentUser.role === "ADMIN") && activeTab !== "nuevos-afectados" && (
                <button type="button" className="nav-dropdown-item" onClick={() => { setActiveTab("nuevos-afectados"); setMenuOpen(false); }}>
