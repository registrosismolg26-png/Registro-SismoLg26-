...
export default function AppHeader() {
  ...
  const closeMenu = () => {
    setMenuClosing(true);
    setTimeout(() => { setMenuOpen(false); setMenuClosing(false); }, 180);
  };
  ...
  return (
    <>
        ...
        <div className="header-main">
          ...
          <div className="header-actions-group">
            <button
              ...
              title="Mi Perfil"
            >
              <span className={`small-avatar small-avatar--${roleClass || "reg"}`} aria-hidden>{initials}</span>
            </button>
            <NotificationBell />
          </div>
        </div>
      ...
      <div className="app-nav">
        ...
        <div className="nav-mobile-menu">
          ...
          {(menuOpen || menuClosing) && (
            <div className={`nav-mobile-dropdown${menuClosing ? " is-closing" : ""}`}>
              {items.map((it) => {
      ...
      <MobileSheet open={profileOpen} onClose={() => setProfileOpen(false)} title="Mi Perfil" className="profile-sheet-modal">
        <div className="profile-sheet-content">
          {/* Header section: Avatar + User Info */}
          <div className="profile-sheet-header">
            <div className={`profile-sheet-avatar profile-sheet-avatar--${roleClass || "reg"}`}>
              {initials}
            </div>
          ...
          <div className="profile-sheet-settings">
            ...
            >
              ...
              <span className="theme-status-text">{theme === "dark" ? "Oscuro" : "Claro"}</span>
            </button>
          </div>
