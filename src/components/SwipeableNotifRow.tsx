...
// Se agarra y se mueve con el dedo/ratón EN VIVO (transform imperativo vía
// useSwipeDismiss, sin re-render → sin lag). Al soltar: izquierda → Descartar,
// derecha → Posponer. Bajo el umbral, vuelve a su sitio. La acción de fondo se
// pinta con data-reveal / data-armed en el contenedor (CSS), también imperativo.
